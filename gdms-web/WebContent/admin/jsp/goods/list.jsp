    ...
    <table class="table table-hover text-center">
      ...
      <c:forEach items="${ model.data }" var="o" >
          ...
          <td>
			...
			<a class="button border-main" href="javascript:void(0)" onclick="revise(this)">
					<span class="icon-edit"></span> 修改 </a>	
					<a style="display:none" class="button border-main" href="javascript:void(0)" onclick="bubble(this)">
...
function updateGtid(gtid ,$select){
	...
	$.ajax({
		...
		success:function(r){
			...
			$tr.children("td:eq(1)").text($select.children("option:selected").text());
			$select.hide();	
		}
	})
}
...
function revise(a){
	var $tr = $(a).parent().parent().parent(); //获取当前td对象
