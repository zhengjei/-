...
public class GoodsModel implements Serializable {
	...
	public String toString() {
		return "GoodsModel [goodsid=" + goodsid + ", rowflag=" + rowflag + ", name=" + name + ", spec=" + spec
				+ ", type=" + type + ", gtid=" + gtid + ", unit=" + unit + ", amount=" + amount + ", price=" + price
				+ ", agio=" + agio + ", area=" + area + ", color=" + color + ", size=" + size + ", weight=" + weight
				+ ", photo=" + photo + ", makedate=" + makedate + ", expirydate=" + expirydate + ", status=" + status
				+ ", push=" + push + "]";
	}
